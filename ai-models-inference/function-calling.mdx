...
<Card title="Function & Tool Calling Cookbook" icon="github" color="#000000" horizontal href="https://github.com/nebius/ai-studio-cookbook/tree/main/tool-calling">
...
<Card title="Structured Output & JSON generation" icon="brackets-curly" color="#000000" horizontal={false}>
