...
title: "Overview"
icon: "code"
description: "Get an inference engine overview"
---
...
See the full list of available models in [Nebius AI Studio](https://studio.nebius.com/).
...
<Card title="Base" icon="coin" horizontal>
...
You can tune the model’s **generation parameters** to adapt outputs for your use case and optimize performance or cost. Nebius AI Studio supports most of OpenAI compatible generation parameters.

Supported parameters vary by interface:
